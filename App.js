...
const Tareas = createStackNavigator({ lista_empresas: lista_empresas,altaTarea: altaTarea, lista_tareas: lista_tareas,modoTablet: modoTablet, modificar_tarea: modificar_tarea,perfil:perfil});
